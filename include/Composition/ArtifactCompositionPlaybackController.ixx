...
public:
  ...
  void
  setPlaybackSpeed(float speed); // 1.0 = normal, 2.0 = 2x, 0.5 = half speed
  ...
  void enableOutputMonitoring(bool enable);
  void setOutputMonitorCallback(
      const std::function<void(bool audioOk, bool videoOk,
                               const QString &context)> &callback);
