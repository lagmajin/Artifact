...
## Asset Icons
- アセットブラウザで使用するアイコン種類は [docs/AssetIcons.md](../docs/AssetIcons.md) を参照してください。
...
- ⚠️ **This is especially critical for files containing non-ASCII characters (e.g., Japanese comments)**
