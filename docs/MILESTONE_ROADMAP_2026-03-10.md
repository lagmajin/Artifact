...
1. [v0.3 Editor Core](./MILESTONE_V0_3_EDITOR_CORE_2026-03-10.md)
- 目的: Undo/Redo・選択同期・削除依存確認の完成

2. [v0.4 Pipeline Foundation](./MILESTONE_V0_4_PIPELINE_FOUNDATION_2026-03-10.md)
- 目的: 保存/出力/バックエンド抽象化/回帰テストの基盤整備

3. [v0.5 Playable Editor](./MILESTONE_V0_5_PLAYABLE_EDITOR_2026-03-11.md)
