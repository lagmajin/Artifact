...
bool tsReadback(Diligent::IRenderDevice*d,Diligent::IDeviceContext*c,Diligent::ITexture*s,ImageF32x4RGBAWithCache&dst,const ArtifactCore::SurfaceColorDescriptor& colorDescriptor){
...
public:
    ...
    void applyGPU(const ImageF32x4RGBAWithCache& src,ImageF32x4RGBAWithCache& dst)override{
        ...
        if(!tsReadback(d,c,ot,dst,src.image().colorDescriptor()))cpu.applyCPU(src,dst);
