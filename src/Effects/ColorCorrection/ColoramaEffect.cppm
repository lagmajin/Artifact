...
public:
    ...
    void applyGPU(const ImageF32x4RGBAWithCache& src, ImageF32x4RGBAWithCache& dst) override {
        ...
        ParamsCB params{}; params.sourceMode=(int)settings_.sourceMode; params.palette=(int)settings_.palette; params.phase=settings_.phase; params.spread=settings_.spread; params.strength=settings_.strength; params.saturationBoost=settings_.saturationBoost; params.contrast=settings_.contrast; params.preserveLuma=settings_.preserveLuma ? 1.0f : 0.0f; std::memcpy(mapped,&params,sizeof(params)); context_->UnmapBuffer(paramsCB_, Diligent::MAP_WRITE);
