...
public:
    ...
    void applyGPU(const ImageF32x4RGBAWithCache& src, ImageF32x4RGBAWithCache& dst) override {
        ...
        ParamsCB params{}; params.r=settings_.color.r; params.g=settings_.color.g; params.b=settings_.color.b; params.density=settings_.density; params.brightness=settings_.brightness; params.contrast=settings_.contrast; params.saturationBoost=settings_.saturationBoost; params.preserveLuma=settings_.preserveLuma ? 1.0f : 0.0f; std::memcpy(mapped,&params,sizeof(params)); context_->UnmapBuffer(paramsCB_, Diligent::MAP_WRITE);
