...
public:
    ...
    Detail::float2 canvasToViewport(Detail::float2 pos) const { return {0.0f, 0.0f}; }
    Detail::float2 viewportToCanvas(Detail::float2 pos) const { return {0.0f, 0.0f}; }
    double lastFrameGpuTimeMs() const { return 0.0; }
    ...
    void drawLineLocal(Detail::float2 p1, Detail::float2 p2, const FloatColor& color1, const FloatColor& color2) {}
    void drawThickLineLocal(Detail::float2 p1, Detail::float2 p12, float thickness, const FloatColor& color) {}
    void drawDotLineLocal(Detail::float2 p1, Detail::float2 p2, float thickness, float spacing, const FloatColor& color) {}
    void drawBezierLocal(Detail::float2 p0, Detail::float2 p1, Detail::float2 p2, float thickness, const FloatColor& color) {}
    void drawBezierLocal(Detail::float2 p0, Detail::float2 p1, Detail::float2 p2, Detail::float2 p3, float thickness, const FloatColor& color) {}
    void drawSolidTriangleLocal(Detail::float2 p0, Detail::float2 p1, Detail::float2 p2, const FloatColor& color) {}
...
// ArtifactIRenderer implementation
...
void ArtifactIRenderer::zoomAroundViewportPoint(Detail::float2 viewportPos, float newZoom) { if (impl_) impl_->zoomAroundViewportPoint(viewportPos, newZoom); }

Detail::float2 ArtifactIRenderer::canvasToViewport(Detail::float2 pos) const { return impl_ ? impl_->canvasToViewport(pos) : Detail::float2(0, 0); }
Detail::float2 ArtifactIRenderer::viewportToCanvas(Detail::float2 pos) const { return impl_ ? impl_->viewportToCanvas(pos) : Detail::float2(0, 0); }

void ArtifactIRenderer::drawRectOutline(float x, float y, float w, float h, const FloatColor& color) { if (impl_) impl_->drawRectOutline(x, y, w, h, color); }
void ArtifactIRenderer::drawRectOutline(Detail::float2 pos, Detail::float2 size, const FloatColor& color) { if (impl_) impl_->drawRectOutline(pos.x, pos.y, size.x, size.y, color); }
void ArtifactIRenderer::drawSolidLine(Detail::float2 start, Detail::float2 end, const FloatColor& color, float thickness) { if (impl_) impl_->drawSolidLine(start, end, color, thickness); }
void ArtifactIRenderer::drawSolidRect(float x, float y, float w, float h) { if (impl_) impl_->drawSolidRect(x, y, w, h); }
void ArtifactIRenderer::drawSolidRect(Detail::float2 pos, Detail::float2 size, const FloatColor& color) { if (impl_) impl_->drawSolidRect(pos, size, color); }
...
void ArtifactIRenderer::drawSprite(float x, float y, float w, float h, const QImage& image) { if (impl_) impl_->drawSpriteLocal(x, y, w, h, image); }
void ArtifactIRenderer::drawRectLocal(float x, float y, float w, float h, const FloatColor& color) { if (impl_) impl_->drawRectLocal(x, y, w, h, color); }
void ArtifactIRenderer::drawRectOutlineLocal(float x, float y, float w, float h, const FloatColor& color) { if (impl_) impl_->drawRectOutlineLocal(x, y, w, h, color); }
void ArtifactIRenderer::drawThickLineLocal(Detail::float2 p1, Detail::float2 p2, float thickness, const FloatColor& color) { if (impl_) impl_->drawThickLineLocal(p1, p2, thickness, color); }
void ArtifactIRenderer::drawDotLineLocal(Detail::float2 p1, Detail::float2 p2, float thickness, float spacing, const FloatColor& color) { if (impl_) impl_->drawDotLineLocal(p1, p2, thickness, spacing, color); }
void ArtifactIRenderer::drawBezierLocal(Detail::float2 p0, Detail::float2 p1, Detail::float2 p2, float thickness, const FloatColor& color) { if (impl_) impl_->drawBezierLocal(p0, p1, p2, thickness, color); }
void ArtifactIRenderer::drawBezierLocal(Detail::float2 p0, Detail::float2 p1, Detail::float2 p2, Detail::float2 p3, float thickness, const FloatColor& color) { if (impl_) impl_->drawBezierLocal(p0, p1, p2, p3, thickness, color); }
void ArtifactIRenderer::drawSolidTriangleLocal(Detail::float2 p0, Detail::float2 p1, Detail::float2 p2, const FloatColor& color) { if (impl_) impl_->drawSolidTriangleLocal(p0, p1, p2, color); }
void ArtifactIRenderer::drawCheckerboard(float x, float y, float w, float h, float tileSize, const FloatColor& c1, const FloatColor& c2) { if (impl_) impl_->drawCheckerboard(x, y, w, h, tileSize, c1, c2); }
void ArtifactIRenderer::drawGrid(float x, float y, float w, float h, float spacing, float thickness, const FloatColor& color) { if (impl_) impl_->drawGrid(x, y, w, h, spacing, thickness, color); }
