    ...
    const QSize& restoreCanvasSize)
{
 ...
 if (!ArtifactCore::artifactIsFinite(bottomRight.x) || !ArtifactCore::artifactIsFinite(bottomRight.y)) return;
 ...
 x = ArtifactCore::artifactClamp(x, gap, ArtifactCore::artifactMax(gap, viewportWidth - width - gap));
 y = ArtifactCore::artifactClamp(y, gap, ArtifactCore::artifactMax(gap, viewportHeight - height - gap));
 ...
 const QRectF reserved[] = {
     ...
     viewportHeight >= 220.0f
         ? QRectF(0.0f, ArtifactCore::artifactMax(0.0f, viewportHeight - 60.0f), viewportWidth, 60.0f)
         : QRectF{}};
 ...
 y = ArtifactCore::artifactClamp(y, gap, viewportHeight - height - gap);
