...
std::vector<EffectCatalogEntry> buildEffectCatalogEntries() {
  return {
      ...
      {EffectPipelineStage::Rasterizer,
       QStringLiteral("effect.colorcorrection.shadowhighlight"),
       QStringLiteral("Shadow / Highlight"), QStringLiteral("Color"),
       QStringLiteral("Lift shadows and recover highlights independently."),
       QStringLiteral("shadow highlight recover tonal color")},
      {EffectPipelineStage::Rasterizer,
      ...
      {EffectPipelineStage::Rasterizer,
       QStringLiteral("effect.colorcorrection.vibrance"),
       QStringLiteral("Vibrance"), QStringLiteral("Color"),
       QStringLiteral("Smart saturation boost protecting saturated tones."),
       QStringLiteral("vibrance saturation skin color")},
      {EffectPipelineStage::Rasterizer,
       QStringLiteral("effect.colorcorrection.posterize"),
       QStringLiteral("Posterize"), QStringLiteral("Color"),
       QStringLiteral("Reduce continuous tones to discrete tonal levels."),
       QStringLiteral("posterize quantize levels tonal color")},
      {EffectPipelineStage::Rasterizer,
       QStringLiteral("effect.colorcorrection.threshold"),
       QStringLiteral("Threshold"), QStringLiteral("Color"),
       QStringLiteral("Convert image to high-contrast black and white."),
       QStringLiteral("threshold binary black white luma color")},
      {EffectPipelineStage::Rasterizer,
       QStringLiteral("effect.colorcorrection.colortint"),
       QStringLiteral("Color Tint"), QStringLiteral("Color"),
       QStringLiteral("Remap shadows and highlights to custom colors."),
       QStringLiteral("tint color tone duotone remap")},
      {EffectPipelineStage::Rasterizer,
       QStringLiteral("effect.colorcorrection.lut"),
       QStringLiteral("Apply LUT"), QStringLiteral("Color"),
       QStringLiteral("Apply 3D LUT look-up table or cinematic presets."),
       QStringLiteral("lut 3d cube look cinematic grade color")},
      {EffectPipelineStage::Rasterizer,
       QStringLiteral("effect.colorcorrection.blackandwhite"),
       QStringLiteral("Black & White"), QStringLiteral("Color"),
       QStringLiteral("Monochrome conversion with 6-color channel weighting."),
       QStringLiteral("black and white monochrome grayscale tone color")},
