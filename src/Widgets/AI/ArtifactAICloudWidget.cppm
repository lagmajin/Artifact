...
SectionCard makeSectionCard(QWidget *parent, const QString &title,
  ...
  frame->setObjectName(QStringLiteral("aiCloudSectionCard"));
...
QString buildCloudSystemPrompt(const AIContext &context) {
  ...
  prompt += QStringLiteral(
      ...
      "- エフェクト追加: "
      "WorkspaceAutomation.addLayerEffect(layerId, effectType)\n"
      "- エフェクト削除: "
      "WorkspaceAutomation.removeLayerEffect(layerId, effectId)\n"
      "- エフェクト有効/無効: "
      "WorkspaceAutomation.setLayerEffectEnabled(layerId, effectId, enabled)\n"
      "- エフェクト順序変更: "
      "WorkspaceAutomation.moveLayerEffect(layerId, effectId, direction)\n"
      "- エフェクト複製: "
      "WorkspaceAutomation.duplicateLayerEffect(layerId, effectId)\n"
      "- エフェクトパラメータ変更: "
      "WorkspaceAutomation.setLayerEffectParameter(layerId, effectId, paramName, value)\n"
      "- エフェクトプリセット保存: "
      "WorkspaceAutomation.saveLayerEffectPreset(layerId, effectId, filePath)\n"
      "- エフェクトプリセット読み込み: "
      "WorkspaceAutomation.loadLayerEffectPreset(layerId, effectId, filePath)\n"
      "- エフェクトプリセット一覧: "
      "WorkspaceAutomation.listLayerEffectPresets(directoryPath)\n"
      "- エフェクトプリセット最近使用: "
      "WorkspaceAutomation.recentLayerEffectPresets(limit)\n"
      "- ワークスペース診断: "
      "WorkspaceAutomation.workspaceDiagnostics()\n"
      "- キーフレーム要約: "
      "WorkspaceAutomation.getLayerKeyframeSummary(layerId)\n"
      "- キーフレーム一括設定: "
      "WorkspaceAutomation.batchSetKeyframes(layerId, keyframes)\n"
      "- プロジェクト項目一括rename: "
      "WorkspaceAutomation.batchRenameProjectItems(items)\n"
      "- プロジェクト項目一括move: "
      "WorkspaceAutomation.batchMoveProjectItemsToFolder(itemIds, parentFolderId)\n"
      "- Null / Solid レイヤー追加: "
...
Artifact::ArtifactAICloudWidget::ArtifactAICloudWidget(QWidget *parent)
  ...
  leftPanel->setObjectName(QStringLiteral("aiCloudLeftPanel"));
  ...
  advancedPanel->setObjectName(QStringLiteral("aiCloudAdvancedPanel"));
  ...
  refreshToolsButton->setObjectName(QStringLiteral("aiCloudRefreshToolsButton"));
  ...
  clearToolLogButton->setObjectName(QStringLiteral("aiCloudClearToolLogButton"));
  ...
  auto *refreshMcpButton =
      new QPushButton(QStringLiteral("Refresh"), leftPanel);
  refreshMcpButton->setObjectName(QStringLiteral("aiCloudRefreshMcpButton"));
  ...
  rightPanel->setObjectName(QStringLiteral("aiCloudRightPanel"));
  ...
  transcriptScrollArea_->setObjectName(QStringLiteral("aiCloudTranscriptScrollArea"));
  ...
  transcriptContent_->setObjectName(QStringLiteral("aiCloudTranscriptContent"));
...
void Artifact::ArtifactAICloudWidget::appendTranscriptMessage(
  ...
  row->setObjectName(QStringLiteral("aiCloudTranscriptRow"));
...
void Artifact::ArtifactAICloudWidget::openModelSelectionPopup() {
  ...
  combo->setObjectName(QStringLiteral("aiCloudPopupCombo"));
