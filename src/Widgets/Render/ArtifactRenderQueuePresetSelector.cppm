...
public:
  ...
  ArtifactRenderFormatCategory currentCategory =
  ...
  void loadPresets() {
    ...
    const auto presets =
        ArtifactRenderFormatPresetManager::instance().presetsByCategory(
            currentCategory);
  ...
  void updateDescription() {
    if (!presetListWidget || !descriptionLabel)
      return;
    ...
    const auto *preset =
        ArtifactRenderFormatPresetManager::instance().findPresetById(presetId);
...
ArtifactRenderQueuePresetSelector::ArtifactRenderQueuePresetSelector(
  ...
  impl_->categoryCombo->addItem(
      QStringLiteral("アニメ画像"),
      static_cast<int>(ArtifactRenderFormatCategory::AnimatedImage));
  impl_->categoryCombo->addItem(
      QStringLiteral("連番画像"),
  ...
  connect(impl_->presetListWidget, &QListWidget::currentItemChanged, this,
          [this]() {
  ...
  connect(impl_->presetListWidget, &QListWidget::itemDoubleClicked, this,
          [this]() {
...
const ArtifactRenderFormatPreset *
ArtifactRenderQueuePresetSelector::selectedPreset() const {
...
void ArtifactRenderQueuePresetSelector::setSelectedPresetId(
    const QString &presetId) {
  if (!impl_->presetListWidget)
    return;
...
void ArtifactRenderQueuePresetSelector::setCategoryFilter(
    ArtifactRenderFormatCategory category) {
...
void ArtifactRenderQueuePresetDialog::setInitialSelection(
